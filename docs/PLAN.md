...
The acme-site `future-projects/Canary/` material (`Compliance_Canary_BRD.docx`, `Compliance_Canary_TRD.docx`) still describes the old compliance product. It should be reframed onto the test-selection thesis before the page goes public.
